...
namespace Redcode.Moroutines
{
    ...
    public class WaitForAny : CustomYieldInstruction
    {
        ...
        /// <summary>
        /// <inheritdoc>
        ///     <cref>WaitFor(Moroutine[])</cref>
        /// </inheritdoc>
        /// </summary>
        /// <param name="moroutines"><inheritdoc>
        ///         <cref>WaitFor(Moroutine[])</cref>
        ///     </inheritdoc>
        /// </param>
        ...
        /// <summary>
        /// <inheritdoc>
        ///     <cref>WaitFor(IEnumerator[])</cref>
        /// </inheritdoc>
        /// </summary>
        /// <param name="instructions"><inheritdoc>
        ///         <cref>WaitFor(IEnumerator[])</cref>
        ///     </inheritdoc>
        /// </param>
        ...
        /// <summary>
        /// <inheritdoc>
        ///     <cref>WaitFor(IEnumerable{IEnumerator})</cref>
        /// </inheritdoc>
        /// </summary>
        /// <param name="instructions"><inheritdoc>
        ///         <cref>WaitFor(IEnumerable{IEnumerator})</cref>
