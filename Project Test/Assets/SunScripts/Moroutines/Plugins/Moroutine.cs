...
namespace Redcode.Moroutines
{
    ...
    public sealed class Moroutine
    {
        ...
        public abstract class MoroutineAwaiter : YieldAwaiter
        {
            ...
            protected MoroutineAwaiter(Moroutine moroutine) => _moroutine = moroutine;
        }
            ...
            private set
            {
                ...
                switch (_state)
                {
                    ...
                    case State.Destroyed:
                        ...
                        break;
                    default:
                        throw new PlayControlException("Wrong moroutine state.");
                }
        ...
        /// <param name="enumerators"><inheritdoc>
        ///         <cref>Create(IEnumerator[])</cref>
        ///     </inheritdoc>
        /// </param>
        /// <returns><inheritdoc>
